...
//    /**
//     * Retrieve the Reblog entry for a given user and original post, if it exists.
//     *
//     * @param username the username of the user who may have reblogged the post
//     * @param postId   the ID of the original post that may have been reblogged
//     * @return an {@link Optional} containing the matching {@link Reblog} if found,
//     *         or an empty {@code Optional} if the user has not reblogged that post
//     */
//    Optional<Reblog> findByUserUsernameAndOriginalPostId(String username, Long postId);
//
//}
